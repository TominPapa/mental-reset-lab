...
insert into public.topic_ideas (topic, category, source, priority, status) values
  ('You Don''t Need Motivation. You Need a System.', 'Action Systems', 'manual', 10, 'used'),
  ...
  ('Protect Your Attention Like Money.', 'Focus Systems', 'manual', 9, 'new'),
  ('Confidence Is Evidence, Not a Feeling.', 'Self-Mastery', 'manual', 8, 'new'),
  ('Your Future Is Built by Boring Repetitions.', 'Action Systems', 'manual', 7, 'new'),
  ('Clarity Comes After Action, Not Before.', 'Action Systems', 'manual', 8, 'new'),
  ('Your Phone Is Training Your Brain Against You.', 'Focus Systems', 'manual', 9, 'new'),
  ('Make the Task Too Small to Avoid.', 'Action Systems', 'manual', 8, 'new'),
  ('The Easiest Life Is Usually the Most Expensive One.', 'Self-Mastery', 'manual', 6, 'new'),
  ('You Are Not Lazy. Your System Is Too Vague.', 'Action Systems', 'manual', 7, 'new'),
  ('Focus Is a Boundary, Not a Mood.', 'Focus Systems', 'manual', 7, 'new'),
  ('Stop Waiting to Feel Ready.', 'Action Systems', 'manual', 7, 'new'),
  ('Your Environment Is Stronger Than Your Willpower.', 'Focus Systems', 'manual', 8, 'new'),
  ...
  ('You Don''t Need More Advice. You Need Repetition.', 'Action Systems', 'manual', 6, 'new'),
  ('Direction Beats Speed.', 'Founder Mindset', 'manual', 7, 'new'),
  ('Action Creates Clarity.', 'Action Systems', 'manual', 6, 'new'),
  ...
  ('Don''t Optimize What You Haven''t Repeated.', 'Founder Mindset', 'manual', 6, 'new'),
  ('The Cost of Comfort Compounds.', 'Self-Mastery', 'manual', 6, 'new'),
  ('Your Calendar Shows Your Real Priorities.', 'Focus Systems', 'manual', 6, 'new'),
  ('The First Win Should Be Too Easy.', 'Action Systems', 'manual', 6, 'new'),
  ...
  ('Build Systems Your Tired Self Can Follow.', 'Action Systems', 'manual', 8, 'new')
...
values
  ...
  ('Direction over speed', 'direction-over-speed',
   ...
   'Founder Mindset', array['direction','focus'], 'published'),
  ('Make it too small to avoid', 'make-it-too-small-to-avoid',
   ...
   'Action Systems', array['habits','systems'], 'published'),
  ('Protect attention like money', 'protect-attention-like-money',
   ...
   'Focus Systems', array['attention','focus'], 'published')
on conflict (slug) do nothing;
